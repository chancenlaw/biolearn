...
model_definitions = {
    ...
    "PCHorvath2": {
        ...
        "model": {
            ...
            "file": "https://storage.googleapis.com/biolearn/PCClock/PCHorvath2_model.csv",
            "rotation": "https://storage.googleapis.com/biolearn/PCClock/PCHorvath2_rotation.csv",
            "center": "https://storage.googleapis.com/biolearn/PCClock/PCHorvath2_center.csv",
            "transform": lambda sum: anti_trafo(sum + 0.474286913743914),
        },
    },
}
